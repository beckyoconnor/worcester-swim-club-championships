...
def main():
    ...
    st.markdown("""
    <div class="fina-explanation">
        <h3>🏊‍♂️ What are FINA Points?</h3>
        <p>
        ...
        <h4>📊 How FINA Points Work:</h4>
        <ul>
            <li><strong>1000 Points</strong> = Performance matching the base time (typically world record level)</li>
        ...
        <p>As swimmers get older, they typically achieve higher FINA points due to:</p>
        <ul>
        ...
        <ul>
            <li><a href='https://www.worldaquatics.com'>World Aquatics Official Website</a> - Governing body for swimming</li>
            <li><a href='https://sites.google.com/view/fina-points/home'>FINA Points Calculator</a> - Calculate your own points</li>
            <li><a href='https://thebingeful.com/what-are-fina-points-in-swimming/'>Understanding FINA Points</a> - Detailed explanation</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
