...
def main():
    ...
    <div style='background-color: #f0f4ff; padding: 2rem; border-radius: 15px; margin: 2rem 0; border-left: 5px solid #2b1f5c; box-shadow: 0 2px 8px rgba(43, 31, 92, 0.1);'>
        <h3 style='color: #1a1d5a; margin-top: 0; margin-bottom: 1.5rem;'>🏊‍♂️ What are FINA Points?</h3>
        ...
        <h4 style='color: #1a1d5a; margin-bottom: 1rem;'>📊 How FINA Points Work:</h4>
        <ul style='color: #374151; margin-bottom: 1.5rem; padding-left: 2rem; line-height: 1.7;'>
        ...
        <h4 style='color: #1a1d5a; margin-bottom: 1rem;'>🎯 Why Age Matters:</h4>
        ...
        <h4 style='color: #1a1d5a; margin-bottom: 1rem;'>📈 What the Charts Show:</h4>
        <p style='color: #374151; margin-bottom: 1.5rem; line-height: 1.7;'>
        ...
        <h4 style='color: #1a1d5a; margin-bottom: 1rem;'>📚 Sources & Further Reading:</h4>
        <ul style='color: #374151; margin-bottom: 0; padding-left: 2rem; line-height: 1.7;'>
